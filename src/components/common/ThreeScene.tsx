    ...
    <div className="w-full h-screen absolute inset-0 -z-10 bg-black">
      <Canvas camera={{ position: [0, 0, 8], fov: 45 }}>
        ...
        <Environment background={false}>
            <Lightformer intensity={2} color="white" position={[0, 5, -9]} scale={[10, 50, 1]} onUpdate={(self) => self.lookAt(0, 0, 0)} />
            <Lightformer intensity={1.5} color="#a855f7" position={[-5, 1, -1]} scale={[10, 2, 1]} onUpdate={(self) => self.lookAt(0, 0, 0)} />
            <Lightformer intensity={1} color="#6366f1" position={[10, 1, 0]} scale={[20, 2, 1]} onUpdate={(self) => self.lookAt(0, 0, 0)} />
        </Environment>
        ...
        <FloatingSphere position={[4, 1, 1]} color="#a855f7" scale={0.4} /> 
        <FloatingSphere position={[1, 3, -1]} color="#ec4899" scale={0.3} />
