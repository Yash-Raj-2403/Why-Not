            ...
            {monthDays.map((date, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`aspect-square p-2 rounded-lg border cursor-pointer transition-all hover:border-neon-purple/50 ${
                    isTodayDate
                      ? 'bg-neon-purple/10 border-neon-purple'
                      : 'bg-white/5 border-white/10 hover:bg-white/10'
                  }`}
                >
                  <div className={`text-sm font-semibold mb-1 ${isTodayDate ? 'text-neon-purple' : ''}`}>
                    {date.getDate()}
                  </div>
              ...
              return (
                <div
                  ...
                  className={`text-center py-3 rounded-lg ${
                    isTodayDate ? 'bg-neon-purple/10 border border-neon-purple' : 'bg-white/5'
                  }`}
                >
                  <div className="text-xs text-slate-400 mb-1">
                    {date.toLocaleDateString('en-US', { weekday: 'short' })}
                  </div>
                  <div className={`text-xl font-bold ${isTodayDate ? 'text-neon-purple' : ''}`}>
                    {date.getDate()}
                  </div>
                </div>
              );
