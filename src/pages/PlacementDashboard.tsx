      ...
      <div className="pt-24 pb-12 px-6 max-w-7xl mx-auto min-h-screen">
        <div className="mb-8 flex justify-between items-center">
          ...
          <Link to="/placement/post">
            <button className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-neon-purple to-neon-purple rounded-lg font-medium hover:scale-105 transition-transform">
              <PlusCircle size={20} />
              Post Opportunity
            </button>
          </Link>
        ...
        {loading ? (
          ...
          <>
            ...
            >
              ...
              <Link to="/placement/applications" className="glass-panel p-6 rounded-xl border border-white/10 hover:border-neon-purple/50 transition-all group">
                <Users className="w-8 h-8 mb-3 text-neon-purple" />
            ...
            >
              <div className="flex items-center justify-between mb-6">
                ...
                <Link to="/placement/applications" className="text-neon-purple text-sm hover:underline">
                  View All
                </Link>
              </div>
